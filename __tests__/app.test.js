...
describe("GET /api/articles/:article_id", () => {
    test("status: 200, responds with the specified article object with the properties author, title, article_id, body, topic, created_at, votes, article_img_url and comment_count, with the correct number of comments on that article", () => {
        return request(app)
            .get("/api/articles/1")
            .expect(200)
            .then(({ body }) => {
...
describe("GET /api/articles", () => {
    ...
    test("status: 200, responds with an array of articles that match sort_by query", () => {
        return request(app)
    ...
    test("status: 400, respods with an error message when passed an invalid order query", () => {
        return request(app)
...
describe("GET /api/users", () => {
    test("status: 200, responds with an array of user objects with the properties username, name and avatar_irl", () => {
        return request(app)
            .get("/api/users")
            .expect(200)
            .then((({ body: { users } }) => {
